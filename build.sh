...
docker run --restart=always -v /root/docker_logs:/home/logs -e MODE=ssserver -e PASSWORD="Marzocchi000" -e TRAFFIC_LIMIT=1024 -p 443:8388 shadowsocks:1.0 /bin/bash -c "cd home && ./start.sh"
