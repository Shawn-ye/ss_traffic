...
# docker run -i -t -v /root/docker_logs:/home/logs -e MODE=ssserver -e PASSWORD="Marzocchi000" -e TRAFFIC_LIMIT=1024 -p 443:8388 shadowsocks:1.0 /bin/bash
docker run -i -t \
-v /root/docker_logs:/home/logs -e MODE=ssserver \
-e PASSWORD="Marzocchi000" -e TRAFFIC_LIMIT=0 \
-e MAX_IP=0 -p 8388:8388 \
shadowsocks:1.0 /bin/bash -c "cd home && ./start.sh"
# docker exec -i -t -v /root/docker_logs:/home/logs -e MODE=ssserver -e PASSWORD="Marzocchi000" -e TRAFFIC_LIMIT=1024 -p 443:8388 shadowsocks:1.0 /bin/bash
